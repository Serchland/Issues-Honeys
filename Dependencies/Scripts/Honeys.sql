...
-- UPDATELABEL = 5,
-- ADDLABELTOIISUE = 6,
-- DELETELABELTOIISUE = 7,

-- ADDMILESTONE = 8,
-- DELETEMILESTONE = 9,
-- UPDATMILESTONE = 10,
-- ADDMILESTONETOIISUE = 11,
-- DELETEMILESTONETOIISUE = 12,

-- ADDCOMMENTTOIISUE = 13,
-- DELETECOMMENTTOIISUE = 14,
-- UPDATECOMMENTTOIISUE = 15,

-- ASSIGNUSERTOIISUE = 16,
-- DELETEUSERTOIISUE = 17
  ...
  BEGIN
      ...
      CREATE TABLE [issues].[LABELS]
        (
           ...
           [NAME]                VARCHAR(50) NOT NULL,
		   [TOTALISSUES] AS [issues].[Function_Totalissues]([ID]),
  ...
  BEGIN
      ...
      CREATE TABLE [issues].ISSUEHISTORICAL
        (
		   ...
		   CONSTRAINT [FK_IssueHistorical_User_Id] FOREIGN KEY ([Fk_CRTNUSER] )
           REFERENCES [issues].[USERS]([ID])
        )
		WITH (DATA_COMPRESSION = PAGE);

      SELECT 'TABLE [issues].[ISSUEHISTORICAL] REGENERATED'
  END
ELSE
  BEGIN
      SELECT 'TABLE [issues].[ISSUEHISTORICAL] NOT EXIST... CREATING TABLE'
      ...
      SELECT 'TABLE [issues].[ISSUEHISTORICAL] CREATED'
  END
...
SELECT 'DUMMY ISSUES HISTORICAL ADDED'
