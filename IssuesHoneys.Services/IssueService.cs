    ...
    public class IssueService : BindableBase, IIssueService
    {
        ...
        public class IssuesResponse : BindableBase
        {
            internal static List<Issue> Issues()
            {
                ...
                result.Add(new Issue() { Id = 0, Author = "99ID9878", Description = " Permitir generación de elementos iguales 7 dígitos", Labels = GetLabels(new List<int>(){ 0, 1, 2, 3, 4}), Millestones = new List<int>() { 1, 2, 3 }, Name = "CAPC 5855459", Projects = null, State = State.IsOpen });
                ...
                result.Add(new Issue() { Id = 3, Author = "99ID9878", Description = " Conectar con aplicaciones de terceros", Labels = GetLabels(new List<int>(){ 0, 1}), Millestones = new List<int>() {3 }, Name = "CAPC 8524587", Projects = null, State = State.IsOpen });
                ...
                result.Add(new Issue() { Id = 7, Author = "99ID5664", Description = " Nueva funcionalidad para permitir agregar cambios", Labels = GetLabels(new List<int>(){ 2, 4}), Millestones = new List<int>() { 1, 2, 3 }, Name = "CAPC 9658632", Projects = null, State = State.IsOpen });
                result.Add(new Issue() { Id = 8, Author = "99ID1122", Description = " Actualización de documentos", Labels = GetLabels(new List<int>(){ 0, 1}), Millestones = new List<int>() { 3, 4 }, Name = "CAPC 175365242112254", Projects = null, State = State.IsOpen });
                ...
                result.Add(new Issue() { Id = 11, Author = "99ID1122", Description = " Mejorar el sistema de seguridad", Labels = GetLabels(new List<int>(){ 0, 1, 4}), Millestones = new List<int>() { 1, 2, 3 }, Name = "CAPC 9371582", Projects = null, State = State.IsOpen });
                ...
                result.Add(new Issue() { Id = 14, Author = "99ID95456", Description = " Generación de elementos en formato binario", Labels = GetLabels(new List<int>(){ 0, 1}), Millestones = new List<int>() { 0, 2, 3 }, Name = "CAPC 2254586", Projects = null, State = State.IsOpen });
