...
namespace IssuesHoneys.Services.Dummies
{
    ...
    public class IssueDummyService : BindableBase, IIssueService
    {
        ...
        private void Init()
        {
            _labels.Add(new Label() { Color = Brushes.Red, Description = "Something isn't working", Id = 0, Name = "bug" });
            _labels.Add(new Label() { Color = Brushes.LightBlue, Description = "New feature or request", Id = 1, Name = "enhancement" });
            _labels.Add(new Label() { Color = Brushes.Green, Description = "Transition phase", Id = 2, Name = "transition" });
            _labels.Add(new Label() { Color = Brushes.Purple, Description = "synchronisation phase", Id = 3, Name = "sincro" });
            _labels.Add(new Label() { Color = Brushes.Gold, Description = "associated to version", Id = 4, Name = "version" });
